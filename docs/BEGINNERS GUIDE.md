...
- [First Time Programing?](#first-time-programing)
  ...
  - [Basics of programming](#basics-of-programming)
    - [Variables](#variables)
      ...
      - [How to set up variables in Verscae:](#how-to-set-up-variables-in-verscae)
      - [Examples:](#examples)
- [](#)
    - [Data Types](#data-types)
      ...
      - [How to set up data types in Verscae:](#how-to-set-up-data-types-in-verscae)
      - [Examples:](#examples-1)
- [](#-1)
    - [Functions](#functions)
      ...
      - [How to set functions in Verscae:](#how-to-set-functions-in-verscae)
      - [Examples:](#examples-2)
- [](#-2)
    - [Classes](#classes)
      ...
      - [How to set up classes in Verscae:](#how-to-set-up-classes-in-verscae)
      - [Examples:](#examples-3)
- [](#-3)
    - [Objects](#objects)
      ...
      - [How to set up objects in Verscae:](#how-to-set-up-objects-in-verscae)
      - [Examples:](#examples-4)
- [](#-4)
    - [Inheritance](#inheritance)
      ...
      - [How to set up inheritance in Verscae:](#how-to-set-up-inheritance-in-verscae)
      - [Examples:](#examples-5)
- [](#-5)
    - [Encapsulation](#encapsulation)
      ...
      - [How to set up encapsulation in Verscae:](#how-to-set-up-encapsulation-in-verscae)
      - [Examples:](#examples-6)
- [](#-6)
    - [Polymorphism](#polymorphism)
      ...
      - [How to set up polymorphism in Verscae:](#how-to-set-up-polymorphism-in-verscae)
      - [Examples:](#examples-7)
- [](#-7)
...
- [](#-10)
    ...
    - [Arrays, Lists, and Dictionaries](#arrays-lists-and-dictionaries)
      ...
      - [How to set up arrays, lists, and dictionaries in Verscae:](#how-to-set-up-arrays-lists-and-dictionaries-in-verscae)
- [](#-11)
...
- [](#-14)
    - [Loops](#loops)
      ...
      - [How to set up loops in Verscae:](#how-to-set-up-loops-in-verscae)
    ...
    - [If, Else, and Else if Statements](#if-else-and-else-if-statements)
      ...
      - [How to set up if, else, and else if statements in Verscae:](#how-to-set-up-if-else-and-else-if-statements-in-verscae)
...
- [](#-15)
    - [While Loops](#while-loops)
      ...
      - [How to set up while loops in Verscae:](#how-to-set-up-while-loops-in-verscae)
...
- [](#-16)
    - [Try, Except, and Finally Statements](#try-except-and-finally-statements)
      ...
      - [How to set up try, except, and finally statements in Verscae:](#how-to-set-up-try-except-and-finally-statements-in-verscae)
...
2) High-level programming languages (also called general-purpose languages)
...
variable_name = value;
```
#### How to set up variables in Verscae:
```swift
variable_name = value
```
...
```
#### How to set up data types in Verscae:
```swift
variable_name: data_type = value
```
...
```
#### How to set functions in Verscae:
```swift
func function_name() {
    // code
}
...
```
#### How to set up classes in Verscae:
```swift
class class_name {
    // code
}
...
```
#### How to set up objects in Verscae:
```swift
object_name = class_name()
```
...
```
#### How to set up inheritance in Verscae:
```swift
class DerivedClassName : BaseClassName {
    // code
}
...
```
#### How to set up encapsulation in Verscae:
```swift
class MyClass {
    func repr(self):
        self.__hiddenVariable = 0
...
```
#### How to set up polymorphism in Verscae:
```swift
class class_name {
    func method_name() {
        // code
...
name = "John"
out < f"Hello, {name}" | newl | red 
// There is no string formatting in Verscae, but you can use string interpolation instead.
```
...
dictionary_name = {key1: value1, key2: value2, key3: value3}
```
#### How to set up arrays, lists, and dictionaries in Verscae:
```swift
array_name = [item1, item2, item3]
list_name = [item1, item2, item3]
dictionary_name = {key1: value1, key2: value2, key3: value3}
...
```
#### How to set up loops in Verscae:
```swift
for item in sequence {
    // Code
}
...
#### How to set up if, else, and else if statements in Python:
```python
if condition:
    # do something
elif condition:
...
```
#### How to set up if, else, and else if statements in Verscae:
```swift
if condition {
    // Code
} 
...
```
#### How to set up while loops in Verscae:
```swift
while condition {
    // Code
}
...
```
#### How to set up try, except, and finally statements in Java:
```java
try {
    // code block to be executed
} catch (exception) {
...
```
#### How to set up try, except, and finally statements in Verscae:
```java
try {
    // Code
} 
