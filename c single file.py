...
Version = '3.0.1' # if you change this value, the compiler will cause an error but it will still compile the code
...
def build(filename, music_option, Version, music_path, decomplie=False):    # Define the build function
    ...
    try:    # Try to run the code
        ...
        try: # don't change this either
            if argv[1] != None or argv[1] != '': # don't change this unless you know what you are doing
                build(argv[1], music_option, Version, music_path, argv[2]) # don't change this unless you know what you are doing
